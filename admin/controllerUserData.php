...
if (isset($_POST['signup'])) {
    ...
    $email_check_query = "SELECT * FROM usertable WHERE email = ?";
    ...
    if(count($errors) === 0){
        ...
        if($data_check){
            ...
            $sender = "From: nasiajnas77@gmail.com";
    ...
    if(isset($_POST['check'])){
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            if($update_res){
                $_SESSION['name'] = $name;
                $_SESSION['email'] = $email;
                header('location:../arena dashboard/index.php');
                exit();
            }else{
    ...
    if(isset($_POST['login'])){
        ...
        $res = mysqli_query($mysqli, $check_email);
